...
def test_integridad_referencial(datos_creditos, datos_tarjetas):
    ...
    df_ids["_merge"] = df_ids["_merge"].astype(str)
...
def test_unicidad_ids(datos_creditos, datos_tarjetas):
    """Verifica que los IDs de cliente sean únicos en ambos datasets"""
    #Créditos
    assert datos_creditos["id_cliente"].is_unique, "Existen IDs duplicados en el dataset de créditos."
    #Tarjetas
    assert datos_tarjetas["id_cliente"].is_unique, "Existen IDs duplicados en el dataset de tarjetas."
####################################################################